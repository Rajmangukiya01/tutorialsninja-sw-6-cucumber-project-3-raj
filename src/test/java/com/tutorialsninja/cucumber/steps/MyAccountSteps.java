...
public class MyAccountSteps {
    ...
    public void iVerifyRegisterAccountText(String expText) {
        Assert.assertEquals("Register account text is not displayed", expText, new MyAccountPage().getRegisterAccountMessage());
    }
    ...
    public void iVerifyLoginAccountText(String expText) {
        Assert.assertEquals("Returning customer message is not displayed", expText, new MyAccountPage().getReturningCustomerMessage());
    }
    ...
    public void iAmVerifyingTheText(String expText) {
        Assert.assertEquals("Account logout not displayed",expText,new MyAccountPage().getAccountLogoutMessage());
    }
    ...
    public void verifyText(String expText)  {
        Assert.assertEquals("Account logout is not displayed",expText,new MyAccountPage().getAccountLogoutMessage());
    }
